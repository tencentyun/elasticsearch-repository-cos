...
public class COSClientSettings {
    ...
    public static final Setting<String> REGION =
            Setting.simpleString("region", Setting.Property.NodeScope, Setting.Property.Dynamic);
    ...
    public static final Setting<ByteSizeValue> CHUNK_SIZE =
            Setting.byteSizeSetting("chunk_size", MAX_CHUNK_SIZE, MIN_CHUNK_SIZE, MAX_CHUNK_SIZE,
                    Setting.Property.NodeScope, Setting.Property.Dynamic);
    public static final Setting<String> END_POINT = Setting.simpleString("end_point", "", Setting.Property.NodeScope, Setting.Property.Dynamic);
}
